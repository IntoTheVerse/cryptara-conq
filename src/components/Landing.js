...
const Landing = () => {
    return (
        <div className='dungeon flex-1 lg:overflow-hidden cursor-sword flex-row font-pixeled'>    
            <div className='dungeon flex-row relative top-0 left-0 h-dvh bg-cover lg:bg-dungeonScene xs:bg-mobile font-pixeled text-white-lace relative z-0'>
                ...
                <div className='xs:hidden sm:hidden md:hidden shrine flex-1 justify-around float-left absolute bottom-0 left-0 h-1/2 w-1/2 z-2 xs:hidden xl:flex'>
                ...
                <div className='xs:hidden lg:flex w-[50vw] h-[50vh] absolute flex-col justify-center items-center bg-transparent z-2 top-0 left-0'>
                ...
                <div className='lg:flex lg:w-[50vw] xs:w-screen h-screen absolute flex-col justify-center items-center z-2 top-0 lg:right-0'>
                    <div className='flex flex-col justify-center items-center lg:space-y-4 xs:space-y-2 lg:mt-[20vh] xs:mt-[12vh] text-white-lace xs:border-amber-400 xs:border-4 lg:border-none bg-zinc-900/75 rounded-lg lg:w-1/2 lg:h-1/2 xs:w-3/4 xs:h-1/2 xs:mx-auto z-2 justify-center items-center align-middle'>
                        <div className='lg:hidden flex flex-col space-y-2 mx-[0.6rem] mt-1 text-white-lace w-3/4 h-3/4 z-2 justify-center items-center'>
                        ...
                        <div className='font-pixeled lg:text-xs xs:text-[0.4rem] xs:text-center lg:mt-2 xs:mt-1 xs:mb-1 text-white-lace lg:w-3/4 xs:w-3/4 xs:h-1/4 z-2 xs:mx-auto'><p><span className='inline-block align-middle'>Built by IntoTheVerse Inc. &nbsp;<img className='w-5 h-5 self-center inline-block align-middle' src={ITV}/></span></p></div>
                            ...
                            <a href="https://rarible.com/" className='lg:hidden xs:bg-rarible xs:bg-contain xs:bg-no-repeat xs:p-3 xs:z-2 xs:h-1/4 xs:w-3/4'><div></div></a>
                        </div>
                    <a href="https://rarible.com/" className='xs:hidden lg:bg-rarible lg:bg-contain lg:bg-no-repeat lg:p-3 lg:z-2 lg:h-1/4 lg:w-3/4'><div></div></a>
                </div>
                {/* </div> */}
