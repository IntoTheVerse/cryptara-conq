            ...
            <div className='dungeon flex-row relative top-0 left-0 h-dvh bg-cover lg:bg-dungeonScene xs:bg-mobile font-pixeled text-white-lace relative z-0'>
                ...
                <div className='xs:hidden sm:hidden md:hidden lg:flex w-[50vw] h-[50vh] absolute flex-col justify-center items-center bg-transparent z-2 top-0 left-0'>
                    <div className='flex flex-col space-y-2 m-auto text-white-lace w-3/4 h-full z-2 justify-center items-center align-middle'>
                        ...
                        <div className='font-pixeled mt-0 text-white-lace text-[0.8rem] w-full z-2 rounded-full'><p><span className='inline-block align-middle'>An epic 2D survival RPG coming soon on Eclipse! &nbsp;<img className='bg-slate-950 rounded-full w-10 h-10 self-center inline-block align-middle' src={Eclipse} alt="Eclipse"/></span></p></div>
                    </div>
                </div>
                <div className='lg:flex lg:w-[50vw] xs:w-screen h-screen absolute flex-col justify-center items-center z-2 top-0 lg:right-0'>
                    <div className='flex flex-col justify-center items-center lg:space-y-4 xs:space-y-2 lg:mt-[20vh] xs:mt-[30vh] text-white-lace xs:border-amber-400 xs:border-4 lg:border-none bg-zinc-900/75 rounded-lg lg:w-1/2 lg:h-1/2 xs:w-3/4 xs:h-1/2 xs:mx-auto z-2 justify-center items-center align-middle'>
                        <div className='lg:hidden xl:hidden flex flex-col space-y-2 mx-[0.6rem] mt-1 text-white-lace w-3/4 h-3/4 z-2 justify-center items-center'>
                            <div className='bg-logo bg-contain bg-center bg-no-repeat h-[15vh] w-full z-2 mt-1 mx-auto items-center px-auto align-middle'></div>
                            <div className='font-pixeled mt-0 text-white-lace text-center text-[0.6rem] w-full mx-1 z-2 rounded-full'><p><span className='inline-block align-middle'>An epic 2D survival RPG coming soon on Eclipse! &nbsp;<img className='bg-slate-950 rounded-full w-5 h-5 self-center inline-block align-middle' src={Eclipse} alt="Eclipse"/></span></p></div>
                        </div>
                        <div className='font-pixeled lg:text-xs xs:text-[0.4rem] xs:text-center lg:mt-2 xs:mt-1 xs:mb-1 text-white-lace lg:w-3/4 xs:w-3/4 xs:h-1/4 z-2 xs:mx-auto'><p><span className='inline-block align-middle'>Built by IntoTheVerse Inc. &nbsp;<img className='xs:w-5 xs:h-5 lg:w-10 lg:h-10 self-center inline-block align-middle' src={ITV} alt="IntoTheVerse"/></span></p></div>
                            <a className='bg-twitter bg-contain bg-no-repeat bg-center p-3 z-2 lg:h-1/4 lg:w-1/2 xs:w-full xs:h-[5vh] xs:m-auto xs:align-middle xs:flex xs:items-center xs:justify-center xs:item-center' href="https://x.com/CryptaraConq" target="_blank" rel="noreferrer"><div></div></a>
                            <a className='bg-discord bg-contain bg-no-repeat bg-center p-3 z-2 lg:h-1/4 lg:w-1/2 xs:w-full xs:h-[5vh] xs:m-auto xs:align-middle xs:flex xs:items-center xs:justify-center xs:item-center' href="https://discord.gg/w94EVQRPRf" rel="noreferrer"><div></div></a>
                            <a className='bg-whitepaper bg-contain bg-no-repeat bg-center p-3 z-2 lg:h-1/4 lg:w-1/2 xs:w-full xs:h-[5vh] xs:m-auto xs:align-middle xs:flex xs:items-center xs:justify-center xs:item-center' href="/CryptaraScroll.pdf"><div></div></a>
